...
/* TO DO
- Enlever les décédés et les deleted (Filtre ou Where ?)
- Rajouter les téléphones fixes par Relation
- Corriger le filtre des dates (date de création et date d'adhésion)
*/

class CRM_Reports_Form_Report_ListeDesMembres extends CRM_Report_Form {
		...
		$this->_columns = array(
			'civicrm_contact' => array(
				...
				'fields' => array(
					...
					'created_date' => array(
						'title' => E::ts('Date de création de la fiche'),
						'type' => CRM_Utils_Type::T_DATE,
						'required' => FALSE,
