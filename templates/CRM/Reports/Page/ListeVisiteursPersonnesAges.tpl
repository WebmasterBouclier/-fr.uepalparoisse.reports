...
<div>
	<ul>
		<li>Liste des paroissiens de plus de 75 ans, classée par ordre alphabétique, non décédé, non rayé du fichier.</li>
...
<div>
	<ul>
		<li>A lister les paroissiens de plus de 75 ans, pour leur envoyer une carte d'anniversaire.</li>
		<li>Cible = Paroissiens de plus de 75 ans, inscrits à la paroisse en tant qu'Electeur ou Ami de la paroisse.</li>
	</ul>
</div>
...
<h3>Liste</h3>
<div>Il y a {$PersonnesAges|@count} personnes affichés</div>
<table class="report-layout display">
			...
			<tbody>
			{foreach from=$PersonnesAges item=row}
